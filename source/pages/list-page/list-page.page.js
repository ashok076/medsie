...
class ListPage extends Component {
  ...
  this.setState({ currentLatitude: currentLatitude, currentLongitude: currentLongitude, access_token: access_token }, () => this.homeData())
}
    ...
    showMap = () => (
        <View>
                <TouchableOpacity style={styles.showMap} onPress={() => this.props.navigation.navigate('ShowMaps', {id: this.props.route.params.id}) }>
